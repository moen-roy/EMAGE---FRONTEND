...
const Button = ({
  ...
  const buttonStyles = {
    fontSize: text_font_size ? `${text_font_size}px` : '22px',
    fontFamily: text_font_family || 'Manrope',
    fontWeight: text_font_weight || '700',
    lineHeight: text_line_height || '31px',
    textAlign: text_text_align || 'center',
    color: text_color || '#ffffff',
    backgroundColor: fill_background_color || '#ec744a',
    borderRadius: border_border_radius || '30px',
  };
